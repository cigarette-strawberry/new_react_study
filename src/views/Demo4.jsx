...
class Child1 extends React.Component {
  ...
  render() {
    return (
      <div>
        子组件1
        <span ref={x => (this.spanBox = x)}>666</span>
      </div>
    )
  }
}
...
const Child2 = React.forwardRef(function Child2(props, ref) {
  console.log(props, ref) // 我们调用Child2的时候，设置的ref属性值[函数] // => x => this.child2 = x
  return (
    <div>
      子组件2
...
给函数组件设置ref，直接报错：Function components cannot be given refs. Attempts to access this ref will fail. Did you mean to use React.forwardRef()?
