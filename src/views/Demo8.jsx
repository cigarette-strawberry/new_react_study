 ...
 * @LastEditTime: 2024-03-14 07:24:03
...
class Demo extends React.Component {
   ...
   * + 我们可以基于JS中bind方法：预先处理函数中的this和实参的
   * + 推荐：我们也可以把绑定的函数设置为“箭头函数”，让其使用上下文中的this「也就是我们的实例」
   *
   *
  ...
  handle2(x, y, ev) {
    // 只要方法经过bind处理后，那么最后一个实参，就是传递的合成事件对象！！
    console.log(this, x, y, ev) // 实例 10 20 合成事件对象
  }
  // 实例.handle3 = () => {...}
  handle3 = ev => {
    console.log(this) // 实例
    console.log(ev) // SyntheticBaseEvent事件合成对象
  }
  handle4 = (x, ev) => {
