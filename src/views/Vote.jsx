...
class Vote extends React.Component {
  ...
  /* componentWillMount() {
    console.log('componentWillMount,组件第一次渲染之前')
  } */

  UNSAFE_componentWillMount() {
    console.log('UNSAFE_componentWillMount,组件第一次渲染之前')
  }

  componentDidMount() {
    console.log('componentDidMount,组件第一次渲染完毕')
  }
  ...
  UNSAFE_componentWillReceiveProps(nextProps) {
    console.log('UNSAFE_componentWillReceiveProps:组件即将从新接收到属性', this.props, nextProps)
  }
}
