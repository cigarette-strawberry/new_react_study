...
class Demo extends React.Component {
  render() {
    return (
      <div className="outer center" onClick={() => console.log('outer 冒泡 「合成」')} onClickCapture={() => console.log('outer 捕获 「合成」')}>
        <div className="inner center" onClick={() => console.log('inner 冒泡 「合成」')} onClickCapture={() => console.log('inner 捕获 「合成」')}></div>
      </div>
    )
  }
  ...
  componentDidMount() {
    ...
    document.querySelector('.inner').addEventListener('click', () => console.log('inner 冒泡「原生」'), false)
  }
}
